  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-brand-orange via-brand-dark to-purple-900 text-white py-24 md:py-40">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          <span className="block text-6xl md:text-9xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-white to-yellow-200 pb-4">
            Fresh Paneer
          </span>
          <span className="block text-3xl md:text-6xl font-light tracking-[0.2em] uppercase text-white/90">
            Fast Delivery
          </span>
        </motion.h1>
        ...
        >
          Experience the taste of <span className="font-semibold text-white">Authentic Purity</span>. 
          Premium Dairy & Spices delivered to your doorstep.
        </motion.p>
        <motion.button 
